const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_GLOOM]      = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_VILEPLUME, 0},
                            ...
                            {EVO_LEVEL, 30, SPECIES_VILEPLUME, 0}},
    ...
    [SPECIES_GROWLITHE]  = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_ARCANINE, 0},
                            {EVO_LEVEL, 30, SPECIES_ARCANINE, 0}},
    ...
    [SPECIES_KADABRA]    = {{EVO_TRADE, 0, SPECIES_ALAKAZAM, 0},
                            ...
                            {EVO_LEVEL, 40, SPECIES_ALAKAZAM, 0}},
    ...
    [SPECIES_SHELLDER]   = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_CLOYSTER, 0},
                            {EVO_LEVEL, 36, SPECIES_CLOYSTER, 0}},
    ...
    [SPECIES_EXEGGCUTE]  = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR, 0},
                            {EVO_LEVEL, 40, SPECIES_EXEGGUTOR, 0}},
    ...
    [SPECIES_CHANSEY]    = {{EVO_LEVEL, 36, SPECIES_BLISSEY, 0}},
    [SPECIES_HORSEA]     = {{EVO_LEVEL, 26, SPECIES_SEADRA, 0}},
    [SPECIES_SEADRA]     = {{EVO_TRADE_ITEM, ITEM_DRAGON_SCALE, SPECIES_KINGDRA, 0},
                            ...
                            {EVO_LEVEL, 38, SPECIES_KINGDRA, 0}},
    [SPECIES_GOLDEEN]    = {{EVO_LEVEL, 28, SPECIES_SEAKING, 0}},
    [SPECIES_STARYU]     = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_STARMIE, 0},
                            {EVO_LEVEL, 38, SPECIES_STARMIE, 0}},
    ...
    [SPECIES_TOGEPI]     = {{EVO_LEVEL, 10, SPECIES_TOGETIC, 0}},
    ...
    [SPECIES_SUNKERN]    = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_SUNFLORA, 0},
                            {EVO_LEVEL, 24, SPECIES_SUNFLORA, 0}},
    ...
    [SPECIES_TYROGUE]    = {{EVO_LEVEL_ATK_LT_DEF, 15, SPECIES_HITMONCHAN, 0},
                            {EVO_LEVEL_ATK_GT_DEF, 15, SPECIES_HITMONLEE, 0},
                            {EVO_LEVEL_ATK_EQ_DEF, 15, SPECIES_HITMONTOP, 0}},
    ...
    [SPECIES_SKITTY]     = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_DELCATTY, 0},
                            {EVO_LEVEL, 20, SPECIES_DELCATTY, 0}},
    ...
    [SPECIES_METANG]     = {{EVO_LEVEL, 50, SPECIES_METAGROSS, 0}},
};
