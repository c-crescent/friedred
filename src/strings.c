...
const u8 gText_DexCategory_SeviiPkmn[] = _("Sevii variant POKéMON");
...
const u8 gText_PartyMonScared[] = _("{PKMN} is too scared to do this!");
...
const u8 gText_Ruby[] = _("RUBY");
const u8 gText_Sapphire[] = _("SAPPHIRE");
const u8 gText_Emerald[] = _("EMERALD");
const u8 gText_NoPlace[] = _("Nevermind");
...
const u8 gText_Tm13_2000Coins[] = _("TM13{CLEAR_TO 0x48}{FONT_SMALL}2,000 COINS");
const u8 gText_Tm23_2000Coins[] = _("TM23{CLEAR_TO 0x48}{FONT_SMALL}2,000 COINS");
const u8 gText_Tm24_2000Coins[] = _("TM24{CLEAR_TO 0x48}{FONT_SMALL}2,000 COINS");
const u8 gText_Tm30_2000Coins[] = _("TM30{CLEAR_TO 0x48}{FONT_SMALL}2,000 COINS");
const u8 gText_Tm35_2000Coins[] = _("TM35{CLEAR_TO 0x48}{FONT_SMALL}2,000 COINS");
...
const u8 gText_Wynaut_100Coins[] = _("WYNAUT{CLEAR_TO 0x55}{FONT_SMALL} 100 COINS");
const u8 gText_Castform_500Coins[] = _("CASTFORM{CLEAR_TO 0x55}{FONT_SMALL} 500 COINS");
const u8 gText_Dratini_1000Coins[] = _("DRATINI{CLEAR_TO 0x4B}{FONT_SMALL} 1,000 COINS");
const u8 gText_Scyther_2000Coins[] = _("SCYTHER{CLEAR_TO 0x4B}{FONT_SMALL} 2,000 COINS");
const u8 gText_Porygon_3333Coins[] = _("PORYGON{CLEAR_TO 0x4B}{FONT_SMALL} 3,333 COINS");
const u8 gText_Pinsir_1000Coins[] = _("PINSIR{CLEAR_TO 0x4B}{FONT_SMALL} 1,000 COINS");
const u8 gText_Dratini_2000Coins[] = _("DRATINI{CLEAR_TO 0x4B}{FONT_SMALL} 2,000 COINS");
const u8 gText_Porygon_3333Coins_2[] = _("PORYGON{CLEAR_TO 0x4B}{FONT_SMALL} 3,333 COINS");
...
const u8 gText_RegionMap_AreaDesc_MtSilverCave[] = _("A hallowed mountain that rises\nbetween the JOHTO and\nKANTO regions.");
const u8 gText_RegionMap_AreaDesc_FieryPassage[] = _("A passageway filled with\ngeysers and hot springs,\nresulting in its steamy environment.\nIt is said to connect to MT. MOON.");
const u8 gText_RegionMap_AreaDesc_TohjoFalls[] = _("The TOHJO waterfall that links\nthe KANTO and JOHTO regions.");
...
const u8 gText_PlayerWhitesOutToElm[] = _("{PLAYER} scurried to PROF. ELM's LAB,\nprotecting the exhausted and fainted\nPOKéMON from further harm‥\p");
...
const u8 gText_Hardy[] = _("Hrdy");
const u8 gText_Lonely[] = _("Lnly");
const u8 gText_Adamant[] = _("Admnt");
const u8 gText_Naughty[] = _("Nghty");
const u8 gText_Brave[] = _("Brave");
const u8 gText_Bold[] = _("Bold");
const u8 gText_Docile[] = _("Dcle");
const u8 gText_Impish[] = _("Impsh");
const u8 gText_Lax[] = _("Lax");
const u8 gText_Relaxed[] = _("Rlxd");
const u8 gText_Modest[] = _("Mdst");
const u8 gText_Mild[] = _("Mld");
const u8 gText_Bashful[] = _("Bshfl");
const u8 gText_Rash[] = _("Rash");
const u8 gText_Quiet[] = _("Quiet");
const u8 gText_Calm[] = _("Calm");
const u8 gText_Gentle[] = _("Gntl");
const u8 gText_Careful[] = _("Crfl");
const u8 gText_Quirky[] = _("Qurky");
...
const u8 gText_SeviiFormSymbol[] = _("{TRIANGLE}");
