...
const u8 gMoveDescription_HyperBeam[] = _("A highly damaging\nmove that utilizes\nall of the user's\npower.");
...
const u8 gMoveDescription_SkyAttack[] = _("An aerial attack\nthat charges from above.\nThe user also\ntakes serious damage.");
...
const u8 gMoveDescription_StoneEdge[] = _("Stab the foe with\na sharpened stone.\nIt has a high\ncritical-hit ratio.");
